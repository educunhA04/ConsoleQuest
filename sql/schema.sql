...
CREATE TABLE Product (
    id INT PRIMARY KEY,
    category_id INT NOT NULL UNIQUE ON UPDATE CASCADE,
    name TEXT NOT NULL,
    image TEXT,
    description TEXT,
...
CREATE TABLE Wishlist (
    id INT PRIMARY KEY,
    user_id INT NOT NULL ON UPDATE CASCADE,
    product_id INT NOT NULL ON UPDATE CASCADE,
...
CREATE TABLE Order (
    id INT PRIMARY KEY,
    user_id INT NOT NULL UNIQUE ON UPDATE CASCADE,
...
CREATE TABLE Transaction (
    id INT PRIMARY KEY,
    user_id INT NOT NULL UNIQUE ON UPDATE CASCADE,
    order_id INT NOT NULL UNIQUE ON UPDATE CASCADE,
...
CREATE TABLE Order_Product (
    id INT PRIMARY KEY,
    order_id INT NOT NULL ON UPDATE CASCADE,
    product_id INT NOT NULL ON UPDATE CASCADE,
...
CREATE TABLE Report (
    id INT PRIMARY KEY,
    review_id INT NOT NULL ON UPDATE CASCADE,
    user_id INT NOT NULL ON UPDATE CASCADE,
    admin_id INT NOT NULL ON UPDATE CASCADE,
...
CREATE TABLE Notification_User (
    id INT PRIMARY KEY,
    user_id INT NOT NULL ON UPDATE CASCADE,
    notification_id INT NOT NULL ON UPDATE CASCADE,
...
CREATE TABLE User_Shipping (
    id INT PRIMARY KEY,
    user_id INT NOT NULL ON UPDATE CASCADE,
    shipping_id INT NOT NULL ON UPDATE CASCADE,
...
END
$$ LANGUAGE plpgsql;
DROP TRIGGER IF EXISTS trg_admin_purchase_prevention ON ShoppingCart;
...
DROP TRIGGER IF EXISTS trg_restrict_out_of_stock_cart_addition ON ShoppingCart;
...
DROP TRIGGER IF EXISTS trg_own_shopping_cart ON ShoppingCart;
